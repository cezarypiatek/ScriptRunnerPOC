...
namespace GUIConsole.ConPTY
{
    ...
    public sealed class Terminal
    {
        ...
        public void Start(string command, string arguments, int consoleWidth = 80, int consoleHeight = 30)
        {
            ...
            using (var process = ProcessFactory.Start(command, arguments, PseudoConsole.PseudoConsoleThreadAttribute, pseudoConsole.Handle))
            {
